...
which I face. Also, there will be other interesting stuffs related to computer world. I hope it will help me for better understanding and will be like
...
I used my previously gained skills about coding, problem solving and automation to build data pipelines to fetch data from different sources available from the internet and then in the end which can be used by Rokin's machine learning algorithm for training purpose.
